...
import heroImg2 from "../assets/images/hero__2.1.jpg";
import heroImg3 from "../assets/images/hero__3.1.jpg";
    ...
    <div className="container">
        <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
            ...
            <div className="relative">
              <img className="h-full w-full object-cover rounded-lg" src={heroImg2} alt="hero image" />
            ...
            <div className="relative">
              <img className="h-full w-full object-cover rounded-lg" src={heroImg3} alt="hero image" />
              <div className="absolute max-w-[470px] sm:ml-16 xl:ml-10 2xl:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-2">
